    ...
    static let testRecipes: [Recipe] = [
        ...
        Recipe(mainInformation: MainInformation(name: "Beet and Apple Salad",
               ...
               ingredients: [
                    ...
                    Ingredient(name: "Lemon zest", quantity: 0.5, unit: .tbsp),
                    Ingredient(name: "Lemon juice", quantity: 1.5, unit: .tbsp),
        ...
        Recipe(mainInformation: MainInformation(name: "Braised Beef Brisket",
               ...
               ingredients: [
                    ...
                    Ingredient(name: "Caul, Duck, or Chicken Fat", quantity: 3, unit: .tbsp),
        ...
        Recipe(mainInformation: MainInformation(name: "Vegetarian Chili",
               ...
               ingredients: [
                    ...
                    Ingredient(name: "Chili Powder", quantity: 2, unit: .tbsp),
                    Ingredient(name: "Cumin", quantity: 1, unit: .tbsp),
        ...
        Recipe(mainInformation: MainInformation(name: "Chocolate Billionaires",
               ...
               ingredients: [
                    ...
                    Ingredient(name: "Water", quantity: 3, unit: .tbsp),
        ...
        Recipe(mainInformation: MainInformation(name: "Mac & Cheese",
               ...
               ingredients: [
                    ...
                    Ingredient(name: "Butter, divided", quantity: 2, unit: .tbsp),
